...
import com.asedias.monopolyone.domain.model.main_page.Mission
...
class MainFragmentAdapter : RecyclerView.Adapter<MainFragmentAdapter.RoomViewHolder>() {

    private var games: com.asedias.monopolyone.domain.model.main_page.MainPageData? = null
    ...
    fun setData(data: com.asedias.monopolyone.domain.model.main_page.MainPageData) {
        games = data
